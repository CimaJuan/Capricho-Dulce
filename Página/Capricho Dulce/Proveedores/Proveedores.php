...
<body>
    ...
    <div class="container container-proveedores">

    <div class="row">
        <div class="col-lg-4 col-sm-6 col-xs-12">
          <div class="card mb-4 shadow">
            <img src="../img/img-proveedores/proveedor-santos lugos.png" alt="" class="proveedor">
            <div class="card-body">
              <h5 class="card-tittle text-center">EL ABUELO JOSE (SANTOS LUGOS)</h5>
              <p class="card-text"></p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a href="" class="btn btn-detalles">Detalles</a>
                </div>
            ...
            <div class="col-lg-4 col-sm-6 col-xs-12">
              <div class="card mb-4 shadow">
                <img src="../img/img-proveedores/proveedor-flor de trigo.jpg" alt="" class="proveedor">
                <div class="card-body">
                  <h5 class="card-tittle text-center">LA FLOR DE TRIGO</h5>
                  <p class="card-text"></p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <a href="" class="btn btn-detalles">Detalles</a>
                ...
                <div class="col-lg-4 col-sm-6 col-xs-12">
                  <div class="card mb-4 shadow">
                    <img src="../img/img-proveedores/proveedor_eurobakery.jpg" alt="" class="proveedor">
                    <div class="card-body">
                      <h5 class="card-tittle text-center">EURO BAKERY</h5>
                      <p class="card-text"></p>
                      <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                          <a href="" class="btn btn-detalles">Detalles</a>
